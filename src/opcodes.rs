...
lazy_static! {
    pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![        
        ...
        OpCode::new(0x10, "BPL", 2, 2/*+1 if branches, +2 if new page*/, AddressingMode::None),
        OpCode::new(0x30, "BMI", 2, 2/*+1 if branches, +2 if new page*/, AddressingMode::None),

        OpCode::new(0x50, "BVC", 2, 2/*+1 if branches, +2 if new page*/, AddressingMode::None),
        OpCode::new(0x70, "BVS", 2, 2/*+1 if branches, +2 if new page*/, AddressingMode::None),

        OpCode::new(0x90, "BCC", 2, 2/*+1 if branches, +2 if new page*/, AddressingMode::None),
        OpCode::new(0xB0, "BCS", 2, 2/*+1 if branches, +2 if new page*/, AddressingMode::None),

        OpCode::new(0xD0, "BNE", 2, 2/*+1 if branches, +2 if new page*/, AddressingMode::None),
        OpCode::new(0xF0, "BEQ", 2, 2/*+1 if branches, +2 if new page*/, AddressingMode::None),
        ...
        OpCode::new(0x58, "CLV", 1, 2, AddressingMode::None),
        ...
        OpCode::new(0xCA, "DEX", 1, 2, AddressingMode::ZeroPage),

        OpCode::new(0x88, "DEY", 1, 2, AddressingMode::ZeroPage),
        ...
        OpCode::new(0x4A, "LSR", 2, 2, AddressingMode::None),
