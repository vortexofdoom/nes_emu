...
lazy_static! {
    pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
        ...
        OpCode::new(0x1E, "ORA", 3, 4/*+1 if page crossed*/, AddressingMode::AbsoluteX),
        ...
        OpCode::new(0x4C, "JMP", 3, 3, AddressingMode::None), //AddressingMode that acts as Immidiate
        OpCode::new(0x6C, "JMP", 3, 5, AddressingMode::None), //AddressingMode:Indirect with 6502 bug
        ...
        OpCode::new(0x10, "BPL", 2, 2 /*(+1 if branch succeeds +2 if new page)*/, AddressingMode::None),
        OpCode::new(0x30, "BMI", 2, 2 /*(+1 if branch succeeds +2 if new page)*/, AddressingMode::None),
        
        OpCode::new(0x50, "BVC", 2, 2 /*(+1 if branch succeeds +2 if new page)*/, AddressingMode::None),
        OpCode::new(0x70, "BVS", 2, 2 /*(+1 if branch succeeds +2 if new page)*/, AddressingMode::None),
       
        OpCode::new(0x90, "BCC", 2, 2 /*(+1 if branch succeeds +2 if new page)*/, AddressingMode::None),
        OpCode::new(0xB0, "BCS", 2, 2 /*(+1 if branch succeeds +2 if new page)*/, AddressingMode::None),
        
        OpCode::new(0xD0, "BNE", 2, 2 /*(+1 if branch succeeds +2 if new page)*/, AddressingMode::None),
        OpCode::new(0xF0, "BEQ", 2, 2 /*(+1 if branch succeeds +2 if new page)*/, AddressingMode::None),
